...
LABEL org.opencontainers.image.url="https://github.com/00o-sh/homepage"
LABEL org.opencontainers.image.documentation='https://github.com/00o-sh/homepage'
LABEL org.opencontainers.image.source='https://github.com/00o-sh/homepage'
